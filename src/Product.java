...
public class Product {
    ...
    public final void setSku(String sku) { this.sku = sku; }

    public final String getProductName() { return productName; }
    public final void setProductName(String productName) { this.productName = productName; }

    public final double getUnitCost() { return unitCost; }
    public final void setUnitCost(double unitCost) { this.unitCost = unitCost; }

    public final double getSalePrice() { return salePrice; }
    public final void setSalePrice(double salePrice) { this.salePrice = salePrice; }

    public final int getQuantityOnHand() { return quantityOnHand; }
    public final void setQuantityOnHand(int quantityOnHand) { this.quantityOnHand = quantityOnHand; }

    public final int getQuantityNeeded() { return quantityNeeded; }
    public final void setQuantityNeeded(int quantityNeeded) { this.quantityNeeded = quantityNeeded; }

    public final String getSpecialInstructions() { return specialInstructions; }
    public final void setSpecialInstructions(String specialInstructions) { this.specialInstructions = specialInstructions; }
